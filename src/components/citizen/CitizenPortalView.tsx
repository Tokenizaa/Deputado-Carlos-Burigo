      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 bg-white border border-stone-200 rounded-2xl p-6 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 bg-stone-900 hover:bg-black text-white text-sm font-bold px-5 py-2.5 rounded-lg transition-colors shrink-0"
          >
          ...
          <div className="mb-10 bg-emerald-50 border-2 border-[#00A550] rounded-2xl p-6 sm:p-8 text-stone-900 shadow-md animate-fade-in">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-3 flex-1">
                <div>
                  <span className="text-sm font-bold uppercase tracking-wider text-[#00A550]">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  <button
                    ...
                    className="inline-flex items-center gap-2 bg-white border border-stone-300 hover:bg-stone-50 text-stone-800 text-sm font-bold px-4 py-2 rounded-lg transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 bg-[#00A550] hover:bg-emerald-700 text-white text-sm font-bold px-4 py-2 rounded-lg transition-colors"
                  >
                    <Search className="w-3.5 h-3.5 text-[#E1F200]" />
        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-6 sm:p-10 shadow-xs">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-bold uppercase tracking-wider text-stone-700 mb-1.5">
                  Nome Completo *
                </label>
                <input
                  type="text"
                  ...
                  className="w-full text-base bg-stone-50 border border-stone-300 rounded-lg px-3.5 py-2.5 text-stone-900 focus:outline-hidden focus:ring-2 focus:ring-[#00A550]"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full text-base bg-stone-50 border border-stone-300 rounded-lg px-3.5 py-2.5 text-stone-900 font-medium focus:outline-hidden focus:ring-2 focus:ring-[#00A550]"
                >
            ...
            <div className="space-y-4 pt-4 border-t border-stone-200">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full text-base bg-stone-50 border border-stone-300 rounded-lg p-3.5 text-stone-900 focus:outline-hidden focus:ring-2 focus:ring-[#00A550] leading-relaxed"
                />
              </div>
