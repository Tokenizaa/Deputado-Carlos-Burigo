...
export const InformativosView: React.FC = () => {
  ...
  return (
    <section className="bg-white py-12 sm:py-16 lg:py-20" aria-labelledby="informativos-page-title">
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
        <button
          type="button"
          onClick={() => setCurrentView('home')}
          className="mb-10 inline-flex min-h-11 items-center gap-2 text-sm font-bold text-stone-700 hover:text-[#008C45] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#008C45]"
        >
        ...
        <header className="max-w-2xl">
          ...
          <h1 id="informativos-page-title" className="mt-2 text-4xl font-bold tracking-tight text-stone-950 sm:text-5xl">
            Informativos
          </h1>
          <p className="mt-4 text-base leading-7 text-stone-600">
            Publicações do gabinete reunidas em um único lugar.
          </p>
        </header>
            ...
            return (
              <article key={capa.id} className="overflow-hidden border border-stone-200 bg-white">
                <button
                  ...
                  aria-label={url ? 'Abrir informativo' : undefined}
                >
                ...
                <div className="flex min-h-16 items-center justify-between gap-4 border-t border-stone-200 px-5 py-4">
                  ...
                  {url && (
                    <button
                      ...
                      className="inline-flex shrink-0 items-center gap-2 text-sm font-bold text-stone-900 hover:text-[#008C45]"
                    >
                      Ler
