  ...
  return (
    <div className="space-y-5 sm:space-y-8">
          ...
          <div className="flex items-center gap-1.5 bg-stone-100 p-1 rounded-lg overflow-x-auto max-w-full" aria-label="Modo da plataforma">
            {(['campaign', 'mandate', 'institutional'] as const).map((m) => (
              <button
                ...
                className={`min-h-[44px] px-3 rounded-md text-xs font-bold whitespace-nowrap transition-colors ${mode === m ? 'bg-[#00A550] text-white shadow-xs' : 'text-stone-600 hover:text-stone-900'}`}
              >
      ...
      <section aria-label="Indicadores do gabinete" className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5">
        <button type="button" onClick={() => setActiveTab('demands')} className="text-left bg-white border border-stone-200 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-xs hover:border-[#00A550] transition-colors min-h-[132px]">
        ...
        <button type="button" onClick={() => setActiveTab('news')} className="text-left bg-white border border-stone-200 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-xs hover:border-[#00A550] transition-colors min-h-[132px]">
        ...
        <button type="button" onClick={() => setActiveTab('agenda')} className="text-left bg-white border border-stone-200 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-xs hover:border-[#00A550] transition-colors min-h-[132px]">
