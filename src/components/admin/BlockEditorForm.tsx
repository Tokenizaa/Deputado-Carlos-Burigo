...
export const BlockEditorForm: React.FC<BlockEditorFormProps> = ({ block, onSave, onCancel, isSaving = false }) => {
  ...
  const [mediaUrl, setMediaUrl] = useState(initial.mediaUrl || initial.imageUrl || initial.videoUrl || '');
